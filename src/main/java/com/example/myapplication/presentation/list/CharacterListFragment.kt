...
class CharacterListFragment : Fragment(), OnCharacterClick {
    ...
    override fun onClick(characterInfo: com.example.myapplication.data.model.Character) {
...
interface OnCharacterClick {
    ...
    fun onClick(characterInfo: com.example.myapplication.data.model.Character)
}
